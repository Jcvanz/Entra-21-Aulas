/* 
    Faça um programa que leia as variáveis C e N, respectivamente
    ...
    imprimir o salário total e o salário excedente. O programa só deve 
    parar de* rodar quando o usuário responder "S" na seguinte pergunta, 
